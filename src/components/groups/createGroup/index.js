        ...
        <div className="create-group white-box flex-property div-wrap">
          ...
          <div className="selected-members">
            <p>Selected friends:</p>
            {
              this.state.selectedId.map((friend) =>
                <SelectedFriend status="own" key={friend.id} friendEmail={friend.friendEmail} friendName={friend.friendName} removeFriendFromGroup={this.removeFriendFromGroup(friend.id)}/>
              )
            }
          </div>
          ...
          <div className="group-members" onMouseOver={() => document.body.style.overflow='hidden'} onMouseOut={() => document.body.style.overflow='auto'}>
              <p>Your suggested friends:</p>
              {
                ...
                <FriendBox status="own" key={friend.id} friendEmail={friend.friendEmail} friendName={friend.friendName} addToGroup={this.addFriendToGroup(friend.id)}/>
                )
              }
          </div>
